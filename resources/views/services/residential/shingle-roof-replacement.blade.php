            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 dark:text-white mb-1">Long-Term System Protection</h3>
                                <p class="text-gray-600 dark:text-gray-300">Premium shingle systems can qualify for manufacturer-backed warranties up to 50 years, with Ridgeline workmanship coverage available on qualifying installations.</p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            <svg class="h-6 w-6 text-orange-600 dark:text-orange-400 mr-3 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="space-y-8">
                    ...
                    <div class="rounded-2xl overflow-hidden shadow-lg">
                        <img src="{{ company_cam_url('services.residential.shingle-replacement.inline') }}" alt="{{ company_cam_alt('services.residential.shingle-replacement.inline') }}" class="w-full h-64 object-cover">
                    </div>
                    <!-- Our Process -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white dark:bg-gray-700 rounded-xl p-6">
                    ...
                    <div class="text-orange-600 dark:text-orange-400 font-semibold">Most Economical</div>
                </div>

                <div class="bg-white dark:bg-gray-700 rounded-xl p-6 border-2 border-orange-600">
                    <div class="inline-block bg-orange-600 text-white px-3 py-1 rounded-full text-xs font-bold mb-3">POPULAR</div>
                    ...
                    <div class="text-orange-600 dark:text-orange-400 font-semibold">Best Value</div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-700 rounded-xl p-6">
                    ...
                    <div class="text-orange-600 dark:text-orange-400 font-semibold">Premium Option</div>
                </div>
            </div>
        </div>
    </div>
