        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white dark:bg-gray-700 rounded-xl p-6">
                    ...
                    <div class="text-orange-600 dark:text-orange-400 font-semibold">Quick Patch Available</div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-700 rounded-xl p-6">
                    ...
                    <div class="text-orange-600 dark:text-orange-400 font-semibold">Critical Repair</div>
                </div>
            </div>
        </div>
    </div>
