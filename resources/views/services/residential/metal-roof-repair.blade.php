<x-layouts.app title="Metal Roof Repair - Residential">
    ...
    <div class="relative text-white py-24 md:py-32 overflow-hidden">
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('img/metal/33ab4c42-0c47-414c-9bcb-0d87303e732b.jpg') }}');"></div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="text-xl md:text-2xl max-w-3xl mx-auto mb-8 text-gray-100">
                    Expert metal roof repair services for standing seam and corrugated panel systems. Fix leaks, fastener issues, and panel damage.
                </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white dark:bg-gray-700 rounded-xl p-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 mb-4">Even galvanized metal can rust over time. Significant rust often calls for panel replacement, while minor surface rust may be addressed with sanding and coating on a case-by-case basis.</p>
                    <div class="text-orange-600 dark:text-orange-400 font-semibold">Repair Scope Depends on Severity</div>
                </div>
