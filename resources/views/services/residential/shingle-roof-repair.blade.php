<x-layouts.app title="Shingle Roof Repair - Residential">
    ...
    <div class="relative text-white py-24 md:py-32 overflow-hidden">
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat" style="background-image: url('{ company_cam_url('services.residential.shingle-repair') }');"></div>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 dark:text-white mb-1">Targeted Repairs</h3>
                                <p class="text-gray-600 dark:text-gray-300">Address damaged areas before they spread into larger roofing problems</p>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white dark:bg-gray-700 rounded-xl p-6">
                    ...
                    <div class="text-orange-600 dark:text-orange-400 font-semibold">Quick Fix Available</div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-700 rounded-xl p-6">
                    ...
                    <div class="text-orange-600 dark:text-orange-400 font-semibold">Prevents Leaks</div>
                </div>
