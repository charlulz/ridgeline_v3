<x-layouts.app title="Designer Shingle Replacement - Residential" sticky-mode="call-only" sticky-title="Free Roof Consultation" sticky-subtitle="Call to discuss your roof and next steps" sticky-call-label="Call to Schedule">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 dark:text-white mb-1">Class 4 Hail Resistance</h3>
                                <p class="text-gray-600 dark:text-gray-300">Available on qualifying products for enhanced impact resistance and long-term protection</p>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white dark:bg-gray-700 rounded-xl p-6 border-2 border-orange-600">
                    <div class="inline-block bg-orange-600 text-white px-3 py-1 rounded-full text-xs font-bold mb-3">MOST POPULAR</div>
                    ...
                    <div class="text-orange-600 dark:text-orange-400 font-semibold">GAF Grand Slate / CertainTeed Grand Manor</div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-700 rounded-xl p-6">
                    ...
                    <div class="text-orange-600 dark:text-orange-400 font-semibold">GAF Camelot / CertainTeed Presidential</div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-700 rounded-xl p-6">
                    ...
                    <div class="text-orange-600 dark:text-orange-400 font-semibold">GAF Grand Sequoia / CertainTeed Landmark Premium</div>
                </div>
            </div>
        </div>
    </div>
