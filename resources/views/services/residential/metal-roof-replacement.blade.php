<x-layouts.app title="Metal Roof Replacement - Residential" sticky-mode="call-only" sticky-title="Free Roof Consultation" sticky-subtitle="Call to discuss your roof and next steps" sticky-call-label="Call to Schedule">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 dark:text-gray-300">A long-term roofing option when installed correctly and maintained over time</p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            <svg class="h-6 w-6 text-orange-600 dark:text-orange-400 mr-3 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 dark:text-gray-300">Built for durability, but still benefits from routine inspections and periodic fastener or component maintenance over time</p>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 dark:text-white mb-1">Final Review</h4>
                                <p class="text-gray-600 dark:text-gray-300 text-sm">Complete walkthrough, finish review, and maintenance guidance</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-white dark:bg-gray-700 rounded-xl p-6">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Corrugated / Exposed Fastener Panels</h3>
                    <p class="text-gray-600 dark:text-gray-300 mb-4">A practical metal roofing option for the right residential applications, with visible fasteners and a more traditional panel profile.</p>
                    <div class="text-orange-600 dark:text-orange-400 font-semibold">Practical Performance</div>
                </div>
            </div>
        </div>
    </div>
