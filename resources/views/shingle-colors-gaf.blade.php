<x-layouts.app
    ...
    metaDescription="Browse GAF Timberline HDZ shingle colors. Explore 12 High Definition colors with GAF's interactive color gallery from Ridgeline Roofing."
    :canonical="route('shingle-colors.gaf')"
>
    ...
    <div class="py-16 bg-gray-50 dark:bg-gray-800/50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 text-center mt-6 leading-relaxed">
                Color widgets are provided by GAF. Product availability may vary by region. Before selecting a color, ask to see several full-size shingle samples.
            </p>
        </div>
    </div>
</x-layouts.app>
