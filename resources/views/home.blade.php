                ...
                <div class="group rounded-3xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div class="p-8">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            ...
                            <a
                                href="{{ route('shingle-colors.owens-corning') }}"
                                class="inline-flex flex-1 items-center justify-center bg-[#e4002b] hover:bg-[#c40025] text-white px-6 py-4 rounded-xl font-bold text-lg transition-all duration-200 shadow-lg hover:shadow-xl"
                            >
                                Owens Corning
                                <svg class="ml-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
