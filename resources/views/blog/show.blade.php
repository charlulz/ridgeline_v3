<x-layouts.app :title="$post->meta_title ?? $post->title">
    ...
    <div class="bg-gradient-to-r from-orange-600 to-orange-800 text-white py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-4">
                <a href="{{ route('blog.index') }}" class="text-orange-200 hover:text-white transition-colors">
                    ← Back to Blog
                </a>
            </div>
                        ...
                        <article class="bg-white dark:bg-gray-700 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                            ...
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">
                                    <a href="{{ route('blog.show', $relatedPost) }}" class="hover:text-orange-600 dark:hover:text-orange-400">
                                        {{ $relatedPost->title }}
                                    </a>
                                </h3>
