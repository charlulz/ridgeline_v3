<x-layouts.app
    title="GAF & Owens Corning Shingle Colors"
    metaDescription="Browse GAF Timberline HDZ and Owens Corning TruDefinition Duration shingle colors. Explore 12 GAF colors and 15 Owens Corning colors with interactive manufacturer widgets from Ridgeline Roofing."
...
>
    <div class="relative text-white py-16 sm:py-20 lg:py-24 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-base md:text-lg max-w-3xl mx-auto leading-relaxed text-orange-50/95">
                Explore manufacturer color options for two of our most popular architectural shingle lines. Use the interactive tools below to compare granule blends, then schedule a free inspection to see full-size samples in person.
            </p>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 p-6">
                    <div class="flex items-center gap-4 mb-3">
                        <img src="{{ asset('img/GAF_logo.png') }}" alt="GAF" class="h-10 w-auto">
                        <div>
                            <h2 class="text-xl font-bold text-gray-900 dark:text-white">GAF Timberline HDZ</h2>
                            <p class="text-sm text-gray-600 dark:text-gray-300">12 High Definition colors</p>
                        </div>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                        GAF's #1-selling architectural shingle with LayerLock technology, StainGuard Plus algae protection, and dimensional shadow lines.
                    </p>
                </div>
                <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 p-6">
                    <div class="flex items-center gap-4 mb-3">
    ...
    <section class="py-16 bg-gray-50 dark:bg-gray-800/50" aria-labelledby="gaf-colors-heading">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-10">
                <h2 id="gaf-colors-heading" class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                    GAF Timberline HDZ Colors
                </h2>
                <p class="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                    Interactive color gallery provided by GAF. Screen colors may vary from installed shingles — we bring full-size samples to every consultation.
                </p>
            </div>

            <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-xl overflow-hidden">
                <iframe
                    src="https://widgets.gaf.com/hdz-widget"
                    title="GAF Timberline HDZ Shingle Colors"
                    class="block w-full min-h-[1000px] border-0"
                    loading="lazy"
                ></iframe>
            </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="rounded-2xl border border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-950/30 p-8 text-center">
                ...
                <p class="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                    Online tools are a great starting point, but nothing replaces seeing full-size shingle boards against your brick, siding, and trim in natural light. Ridgeline Roofing is a GAF-certified contractor and can help you choose the right color for your tri-state home.
                </p>
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 text-center mt-6 leading-relaxed">
                Color widgets are provided by GAF and Owens Corning. Product availability may vary by region. Before selecting a color, ask to see several full-size shingle samples.
            </p>
        </div>
    </div>
