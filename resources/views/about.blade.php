<x-layouts.app title="About Us">
    ...
    <div class="relative py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 bg-gradient-to-br from-orange-600/20 via-orange-700/10 to-orange-800/20"></div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 rounded-2xl p-8">
                    <div class="text-center">
                        <div class="h-24 w-24 bg-orange-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
