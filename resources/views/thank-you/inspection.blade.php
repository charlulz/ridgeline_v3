<x-layouts.app title="Thank You - Inspection Request">
    <div class="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 dark:from-gray-900 dark:to-gray-800 flex items-center py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <!-- Success Icon -->
            <div class="mb-8">
                <div class="mx-auto h-24 w-24 bg-orange-100 dark:bg-orange-900 rounded-full flex items-center justify-center">
            ...
            <div class="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-xl p-6 mb-8">
                <h3 class="text-lg font-semibold text-orange-900 dark:text-orange-200 mb-4">What Happens Next?</h3>
